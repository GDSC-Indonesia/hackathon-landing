    ...
    >
      ...
      <div className="mx-16 mt-9 lg:mt-0 lg:w-1/2">
        ...
        <p className="mt-2 leading-relaxed">
          Created by the United Nations in 2015, with support from all <br />{' '}
          193 United Nations Member States, the 17 Sustainable <br />{' '}
          Development Goals aim to end poverty, ensure prosperity, and <br />{' '}
          protect the planet.
        </p>
      </div>
    </Container>
